...
public class Config {
	...
	public static final IntegerConfig BLOCK_THRESHOLD = new IntegerConfig("lighty.block_threshold", 7, 0, 15);
	...
	public static final ColorConfig OVERLAY_GREEN = new ColorConfig("lighty.overlay_green", new Color(0, 255, 0));
	public static final ColorConfig OVERLAY_ORANGE = new ColorConfig("lighty.overlay_orange", new Color(255, 102, 0));
	public static final ColorConfig OVERLAY_RED = new ColorConfig("lighty.overlay_red", new Color(255, 0, 0));
